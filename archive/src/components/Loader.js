...
const Loader = () => {
  useEffect(() => {
    ...
    const listenerSVG = () => {
      ...
      logoSVG.style.animation = 'heart-beating 1500ms cubic-bezier(0,-0.2,1,1.2) alternate infinite both';
